...
public class BillingConfiguration {
    ...
    @Bean
    public PayPaymentOrderUseCase payPaymentOrderUseCase(PaymentOrderRepository paymentOrderRepository) {
        return new PayPaymentOrderUseCase(paymentOrderRepository);
    }
